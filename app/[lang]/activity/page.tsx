...
> = {
  en: {
    ...
    regsSummary: "The University Regulation and the Faculty Notice on student activities, set out provision by provision.",
    newsTitle: "News",
  ...
  th: {
    ...
    regsSummary: "ข้อบังคับมหาวิทยาลัยและประกาศคณะว่าด้วยกิจกรรมนักศึกษา จัดเรียงเป็นรายข้อ",
