...
> = {
  en: {
    ...
    regsSummary: "The Faculty's official Notice on student activities, set out provision by provision.",
    newsTitle: "News",
  ...
  th: {
    ...
    regsSummary: "ประกาศฉบับทางการของคณะว่าด้วยกิจกรรมนักศึกษา จัดเรียงเป็นรายข้อ",
