...
export async function generateMetadata({
  ...
  const title = stepTitle(
    buildContactWizardLabels(locale).messageHeading((await getContactDraft()).category),
    journey
  );
  return buildMetadata({ locale, title, description: journey, path: "/contact/message" });
}
