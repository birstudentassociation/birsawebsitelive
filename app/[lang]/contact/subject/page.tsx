...
export async function generateMetadata({
  ...
  const title = stepTitle(buildContactWizardLabels(locale).subjectHeading, journey);
  return buildMetadata({ locale, title, description: journey, path: "/contact/subject" });
}
