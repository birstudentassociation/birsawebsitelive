...
> = {
  en: {
    title: "Clubs",
    lede: "Clubs are small groups of BIR students who share an interest — sport, debate, film, volunteering and more. Anyone can join one, and anyone can start a new one.",
    placeholderNotice:
