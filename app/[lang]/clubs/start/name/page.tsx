...
export async function generateMetadata({
  ...
  const title = stepTitle(buildStartClubWizardLabels(locale).nameHeading, journey);
  return buildMetadata({ locale, title, description: journey, path: "/clubs/start/name" });
}
    ...
    <>
      ...
      <div className="wrap max-w-[var(--measure)] py-10">
        <div className="flex flex-col gap-6">
          ...
          />
          <CollectionNotice activityId="club-proposal" locale={locale} />
        </div>
      </div>
    </>
  );
