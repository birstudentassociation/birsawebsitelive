 ...
 * nonce-based policy (applied by `proxy.ts` for the officer console).
 *
 ...
 * TypeScript/webpack pipeline the way application code does. `proxy.ts`
 ...
 * move out of the proxy and into `next.config.mjs`'s `headers()`, where the
