...
export const foodGroups: PlaceGroup[] = [
  {
    ...
    places: [
      ...
      {
        id: "kua-gai-pa-pien",
        name: { en: "Kuay Teow Kua Gai Aunty Pien", th: "ก๋วยเตี๋ยวคั่วไก่ป้าเปี๊ยน" },
        category: cat.noodles,
        area: "oldtown",
        lat: 13.76,
        lng: 100.4988,
...
export const housingPlaces: Place[] = [
  ...
  },
  {
    ...
    ratingCount: 278,
    note: {
      en: "Next to MRT Fai Chai, one stop from Bang Khun Non.",
      th: "ติด MRT ไฟฉาย เดินทางเข้าเมืองสะดวก",
    },
