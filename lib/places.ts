 ...
 *
 * Food coordinates are approximate (eyeballed to the right street or block,
 * not surveyed); the housing coordinates below were taken from each place's
 * own Google Maps pin. Either way they are only orientation aids;
