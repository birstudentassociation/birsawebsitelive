...
export const part07: Part = {
  num: 7,
  title: {
    en: "BIR cohort committees (คกร. BIR)",
    th: "คณะกรรมการแกนนักศึกษาสาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ",
  },
  provisions: [
    {
      num: 62,
      title: { en: "Establishment of the คกร. BIR", th: "การจัดตั้ง คกร. BIR" },
      lead: {
        en: "There shall be a “Politics and International Relations (English Programme) Cohort Committee, Class of…”, abbreviated as “คกร. BIR”, responsible for coordinating year-group activities of the cohort for the BIR programme.",
        th: "ให้มี “คณะกรรมการแกนนักศึกษา สาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ รุ่น…” ชื่อย่อ “คกร. BIR” เป็นผู้ประสานงานกิจกรรมชั้นปีของรุ่นประจำสาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ",
      },
    },
    {
      num: 63,
      title: { en: "Election of the BIR cohort leaders", th: "การเลือกตั้งแกนนักศึกษา BIR" },
      lead: {
        en: "BIRSA shall arrange the election of the BIR programme cohort leaders, Class of…, to be completed within 60 days from the opening of the first-year students' first semester, unless there is a reasonable necessity/emergency, in which case it shall be at the Dean's discretion to extend the time as appropriate, and the date, time, and place of the election shall be announced to students not less than 15 days in advance.",
        th: "ให้สโมสรนักศึกษาสาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ ดำเนินการจัดการเลือกตั้งแกนนักศึกษา สาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ รุ่น… ให้แล้วเสร็จภายใน 60 วัน ตั้งแต่เปิดภาคการศึกษาแรกของนักศึกษาชั้นปีที่ 1 เว้นแต่มีเหตุจำเป็น/ฉุกเฉินอันสมควร ให้เป็นดุลพินิจของคณบดีในการขยายเวลาได้ตามความเหมาะสม และให้ประกาศวัน เวลา และสถานที่ที่จะมีการเลือกตั้งให้นักศึกษาทราบล่วงหน้าไม่น้อยกว่า 15 วัน",
      },
    },
    {
      num: 64,
      title: { en: "Composition of the คกร. BIR", th: "องค์ประกอบของ คกร. BIR" },
      lead: {
        en: "The BIR programme cohort leaders, Class of…, shall appoint the คกร. BIR, which shall comprise:",
    ...
    {
      num: 66,
      title: { en: "Removal or change of the คกร. BIR", th: "การถอดถอนหรือเปลี่ยนแปลง คกร. BIR" },
      lead: {
        en: "The removal or replacement of the คกร. BIR shall be at the discretion of the BIR programme cohort leaders, Class of…",
        th: "การถอดถอนหรือเปลี่ยนแปลง คกร. BIR ให้เป็นไปตามดุลยพินิจของแกนนักศึกษาสาขาการเมืองและการระหว่างประเทศ ภาคภาษาอังกฤษ รุ่น…",
      },
    },
    {
      num: 67,
