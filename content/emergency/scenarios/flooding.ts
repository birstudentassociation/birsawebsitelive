...
const flooding: EmergencyScenario = {
  ...
  th: {
    ...
    extraContacts: [
      { label: "สายด่วนน้ำท่วมและระบายน้ำ กทม.", value: "1555 (ตลอด 24 ชั่วโมง)", href: "tel:1555" },
      { label: "ศูนย์ควบคุมระบบป้องกันน้ำท่วมหลัก กทม.", value: "02-248-5115", href: "tel:0224851115" },
