...
const activeShooting: EmergencyScenario = {
  ...
  en: {
    ...
    extraContacts: [
      ...
      { label: "Bangkok Erawan Medical Centre (Bangkok EMS coordination)", value: "1646", href: "tel:1646" },
    ],
  },
  th: {
    bannerMessage: "หากมีเหตุคนร้ายก่อเหตุรุนแรงในมหาวิทยาลัย ให้ยึดหลัก \"หนี ซ่อน สู้\" และโทรแจ้ง 191 ทันทีที่ปลอดภัย",
    ...
    extraContacts: [
      ...
      { label: "ศูนย์เอราวัณ กรุงเทพมหานคร (ประสานงานการแพทย์ฉุกเฉินในกรุงเทพฯ)", value: "1646", href: "tel:1646" },
    ],
  },
};
