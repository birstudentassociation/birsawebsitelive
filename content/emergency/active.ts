  ...
  updates: [
    ...
    },
    {
      ...
      text: {
        ...
        th: "ผู้ที่ที่พักเสียหายหรือน้ำท่วมถึงที่พัก ยื่นขอรับเงินช่วยเหลือจาก กทม. ได้แล้ว หน้านี้อธิบายขั้นตอน และจุดที่น่าจะมีน้ำท่วมบริเวณท่าพระจันทร์ในสัปดาห์หน้า",
      },
      points: {
        en: [
        ...
        th: [
          ...
          "น้ำทะเลหนุนสูงสุดของเดือนไปจนถึงราววันที่ 3 ตุลาคม น้ำขึ้นสูงทุกค่ำช่วงประมาณ 19.00 ถึง 22.00 น. และตั้งแต่วันที่ 29 กันยายนจะขึ้นสูงอีกรอบช่วงเช้า หากฝนตกหนักช่วงน้ำขึ้น น้ำอาจเอ่อจากท่อระบายน้ำบริเวณประตูท่าพระจันทร์และคณะศิลปศาสตร์ ระวังเมื่ออยู่ที่ท่าเรือช่วงน้ำขึ้น",
        ],
      },
    },
    {
