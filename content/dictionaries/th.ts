...
export const th: typeof en = {
  ...
  emergencyBanner: {
    label: "ประกาศเหตุฉุกเฉิน",
    defaultMessage: "นี่คือประกาศเหตุฉุกเฉิน กรุณาติดตามข้อมูลล่าสุดผ่านช่องทางทางการของ BIRSA",
  },
  ...
  error: {
    ...
    body: "โปรดลองใหม่อีกครั้งในอีกสักครู่ ถ้ายังเกิดปัญหาอยู่ โปรดแจ้งเรา แล้วเราจะรีบตรวจสอบ",
  ...
  courseReview: {
    ...
    noReviewBody:
      "BIRSA ยังไม่มีรีวิวจากนักศึกษาสำหรับวิชานี้ ถ้าคุณเคยเรียนวิชานี้และยินดีเขียนรีวิวสั้น ๆ อย่างตรงไปตรงมา ติดต่อเราได้เลย",
