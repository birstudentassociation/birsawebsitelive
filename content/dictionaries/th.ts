...
export const th: typeof en = {
  ...
  site: {
    ...
    description:
      "ข่าว กิจกรรม บริการนักศึกษา ชมรม และคู่มือการใช้ชีวิต โดยสโมสรนักศึกษาหลักสูตรการเมืองและการระหว่างประเทศ (BIR) มหาวิทยาลัยธรรมศาสตร์",
  },

  nav: [
    { href: "/news", label: "ข่าวและกิจกรรม" },
    { href: "/services", label: "บริการนักศึกษา" },
