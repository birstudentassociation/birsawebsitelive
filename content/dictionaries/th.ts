...
export const th: typeof en = {
  ...
  notFound: {
    title: "ไม่พบหน้านี้",
    typed: "หากคุณพิมพ์ที่อยู่เว็บเอง ตรวจสอบว่าพิมพ์ถูกต้อง",
    pasted: "หากคุณวางที่อยู่เว็บที่คัดลอกมา ตรวจสอบว่าคัดลอกมาครบทั้งหมด",
    contactLead: "หากที่อยู่เว็บถูกต้อง หรือคุณมาจากลิงก์หรือปุ่มบนเว็บไซต์นี้",
    contactLink: "แจ้ง BIRSA ว่าคุณพยายามเปิดหน้าใด",
    home: "กลับหน้าแรก",
    search: "ค้นหาในเว็บไซต์นี้",
  },

  error: {
    title: "ขออภัย ระบบมีปัญหา",
    body: "ลองใหม่อีกครั้งภายหลัง",
    saved: "หากคุณกำลังกรอกแบบฟอร์ม คำตอบที่กรอกไปแล้วจะถูกเก็บไว้ 30 นาที",
    contactLead: "หากยังเกิดปัญหาซ้ำ",
    contactLink: "แจ้ง BIRSA ว่าคุณกำลังทำอะไรอยู่",
