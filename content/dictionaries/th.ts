...
export const th: typeof en = {
  ...
  emergencyPage: {
    ...
    indexTitle: "คำแนะนำเหตุฉุกเฉิน",
    indexLede:
      "สิ่งที่ต้องทำเมื่อเกิดเหตุฉุกเฉินที่ส่งผลต่อมหาวิทยาลัยธรรมศาสตร์ ท่าพระจันทร์ หรือคณะ เขียนเตรียมไว้ล่วงหน้าและตรวจสอบกับคำแนะนำของหน่วยงานทางการ",
    noAlertTitle: "ขณะนี้ไม่มีการแจ้งเตือนสำคัญ",
    noAlertBody:
      "หากมีเหตุเกิดขึ้น จะมีแถบแจ้งเตือนขึ้นที่ด้านบนของทุกหน้าในเว็บไซต์นี้ และแสดงรายละเอียดที่หน้านี้",
    liveAlert: "แจ้งเตือนสำคัญ",
    issued: "ประกาศเมื่อ",
    ...
    readGuide: "อ่านสิ่งที่ต้องทำ",
    notLiveTitle: "ขณะนี้ไม่มีการแจ้งเตือนเรื่องนี้",
    notLiveBody: "หน้านี้เป็นคำแนะนำให้อ่านเตรียมไว้ก่อนเกิดเหตุ",
    seeAll: "ดูคำแนะนำเหตุฉุกเฉินทั้งหมด",
    callForHelp: "โทรขอความช่วยเหลือ",
    callForHelpLede: "โทรฟรีจากทุกเครือข่าย ตลอด 24 ชั่วโมง",
    guides: "คำแนะนำแยกตามเหตุการณ์",
    groups: {
      life: "เหตุที่เป็นอันตรายต่อชีวิต",
      hazard: "ภัยธรรมชาติและสิ่งแวดล้อม",
      disruption: "เหตุที่กระทบมหาวิทยาลัยและการเรียน",
      unrest: "ความไม่สงบทางการเมือง",
      other: "เหตุอื่น ๆ",
    },
    severity: {
      critical: "วิกฤต",
    ...
    districtFinder: {
      label: "เขตของคุณ",
      hint: "พิมพ์ชื่อเขตเป็นภาษาไทยหรือภาษาอังกฤษ หรือเปิดรายการแล้วเลือกเขต",
      placeholder: "เช่น ลาดกระบัง",
      toggle: "แสดงทุกเขต",
      clear: "ล้าง",
      ...
      none: {
        sandbags:
          "ยังไม่พบประกาศจุดแจกกระสอบทรายของเขตนี้ สำนักงานเขตทุกแห่งแจกกระสอบทราย โปรดโทรสอบถามก่อนเดินทาง",
        shelters:
          "ยังไม่พบประกาศศูนย์พักพิงของเขตนี้ ตรวจสอบได้ที่ BMA Flood Support หรือโทรสอบถามสำนักงานเขต หรือสายด่วน 1555",
        parking: "ยังไม่พบประกาศจุดจอดรถฟรีในเขตนี้ ลองดูเขตใกล้เคียง หรือโทรสายด่วน 1555",
      },
    },
    sources: "ที่มาของคำแนะนำ",
    reviewed: "ตรวจสอบล่าสุด",
    disclaimer:
      "คำแนะนำนี้มาจากเว็บไซต์ที่ดูแลโดยนักศึกษา ในเหตุฉุกเฉิน โปรดทำตามคำแนะนำของหน่วยงานฉุกเฉินและมหาวิทยาลัยธรรมศาสตร์เสมอ",
  },
