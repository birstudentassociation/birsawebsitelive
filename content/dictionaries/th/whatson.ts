...
export const whatson: typeof EnWhatson = {
  whatson: {
    ...
    clubs: {
      ...
      tuscBody:
        "สภานักศึกษาเป็นผู้อนุมัติและตรวจสอบงบประมาณที่ชมรมและองค์การนักศึกษาเบิกใช้ ครอบคลุมทั้งสามศูนย์",
    ...
    sport: {
      ...
      noFixturesBody:
        "ขณะนี้ BIRSA ยังไม่มีตารางแข่งที่ยืนยันแล้ว ติดต่อชมรมกีฬาโดยตรงเพื่อสอบถามเวลาซ้อมและนัดแข่งของชมรมนั้น",
