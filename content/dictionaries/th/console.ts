...
export const officerConsole: typeof EnOfficerConsole = {
  officerHub: {
    ...
    studioSignInNote:
      "สตูดิโอใช้ระบบเข้าสู่ระบบแยกจากคอนโซลนี้ ให้เข้าสู่ระบบด้วยบัญชี Sanity ที่ BIRSA มอบให้",
    studioHistoryNote:
      "แผนนี้เก็บประวัติเอกสารไว้ {days} วัน หลังจากนั้นต้องให้ผู้ดูแลระบบกู้คืนเวอร์ชันเก่าจากข้อมูลสำรอง",
