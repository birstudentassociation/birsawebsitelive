...
const courses: Course[] = [
  ...
  },
  {
    ...
    category: "concentrationRequired",
    prerequisites: [],
    // The internship is the whole of Year 3 summer: a student doing it does
    // that and nothing else that term. BIRSA's instruction of 2026-08-02; see
    // `isInternshipSummer` and `clearInternshipSummers` in
    // lib/study-plan/derive.ts for what this flag drives.
    internship: true,
  },
  ...
  {
    code: "PI364",
    title: "Middle East in Global Politics",
    credits: 3,
  ...
  {
    code: "PI365",
    title: "Russia in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI366",
    title: "The United States of America in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI367",
    title: "Europe in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI368",
    title: "South Asia in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI369",
    title: "Africa in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI374",
    title: "China in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI375",
    title: "Latin America in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI378",
    title: "Japan in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI474",
    title: "East Asia in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI475",
    title: "Southeast Asia in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  {
    code: "PI476",
    title: "ASEAN in Global Politics",
    credits: 3,
    category: "concentrationElectiveArea",
    prerequisites: ["PI280"],
  },
  ...
  {
    code: "PI376",
    title: "Alternative Approaches in International Relations",
    credits: 3,
  ...
  {
    code: "PI379",
    title: "Religion and Global Politics",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  ...
  {
    code: "PI478",
    title: "Political Psychology and International Relations",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  {
    code: "PI479",
    title: "Global Politics through Film",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  {
    code: "PI483",
    title: "Seminar: Non-Western International Relations Theories",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  {
    code: "PI484",
    title: "Seminar: International Regimes, Institutions, and Governance",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  ...
  {
    code: "PI487",
    title: "The International Relations of Rising Powers",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  {
    code: "PI488",
    title: "Classical Theories in International Relations",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  {
    code: "PI489",
    title: "Epistemology and Global Politics",
    credits: 3,
    category: "concentrationElectiveApproaches",
    prerequisites: [],
  },
  ...
  {
    code: "PI380",
    title: "Nation-State and Transnationalism",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI313",
    title: "Media and Global Politics",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI373",
    title: "Transnational Crime and Global Governance",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI384",
    title: "Selected Topics in Global Governance",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI387",
    title: "Environment and Global Politics",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI388",
    title: "Human Security in Global Politics",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI413",
    title: "Seminar: Globalization, Regional Grouping and the State",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI414",
    title: "Seminar: International Conflict and Resolutions",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI340",
    title: "Public Policy and Management in the Global Context",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI341",
    title: "Policy Analysis and Evaluation: Concepts and Techniques",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI342",
    title: "Organization and Human Resource Management: Theories and Practices",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI344",
    title: "Environmental Management and Policy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI346",
    title: "Urban Planning and Development Policy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI349",
    title: "Information Technology Management in the Public Sector",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI443",
    title: "Selected Topics in Public Policy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI444",
    title: "Selected Topics in Public Administration",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI480",
    title: "Seminar: Issues in Global Political Economy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI395",
    title: "International Political Economy in Asia",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI397",
    title: "Public Choice in Global Affairs",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI399",
    title: "Politics of International Finance",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  ...
  {
    code: "PI495",
    title: "Contemporary Debates in Global Political Economy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI496",
    title: "Economic Diplomacy and Negotiation",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI497",
    title: "Politics of International Trade in Services",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
  {
    code: "PI498",
    title: "Global Politics of Digital Economy",
    credits: 3,
    category: "minor",
    prerequisites: [],
  },
