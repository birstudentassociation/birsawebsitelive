...
export default function DeletePlanButton({
  ...
  return (
    <button
      ...
      className={clsx(
        "focus-halo inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-brand-strong px-5 text-base font-semibold whitespace-nowrap text-white transition-colors duration-150 hover:opacity-85",
        className
      )}
    >
      {children}
