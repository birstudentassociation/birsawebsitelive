...
export default function ScrollToTop({ label }: ScrollToTopProps) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={`focus-halo fixed right-5 bottom-5 z-50 flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-input-border bg-cream text-ink shadow-lg transition-opacity duration-200 hover:bg-sunken ${
