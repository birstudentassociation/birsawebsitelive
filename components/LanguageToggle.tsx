...
export default function LanguageToggle({ locale, label, ariaLabel }: LanguageToggleProps) {
  ...
  return (
    <a
      ...
      className="focus-halo inline-flex h-11 items-center gap-1.5 rounded-full border border-input-border px-3 text-sm font-semibold text-ink hover:bg-sunken sm:px-3.5"
    >
